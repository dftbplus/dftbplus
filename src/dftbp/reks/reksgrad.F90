...
contains
  ...
  subroutine derivative_blockL(env, deriv, derivator, DM, EDM, skHamCont, &
    ...
    do iL = 1, Lmax
      ...
      if (iL == 1) then
        do ii = 1, 3
          call triangleCopySquareMatrix(Hderiv(:,:,ii))
          call triangleCopySquareMatrix(Sderiv(:,:,ii))
        end do
      end if
  ...
  subroutine getSccSpinLrPars(env, sccCalc, hybridXc, coords, species, &
    ...
    call triangleCopySquareMatrix(tmpGamma)
    ...
    do ii = 1, 3
      call triangleCopySquareMatrix(GammaDeriv(:,:,ii))
    end do
    ...
    if (isHybridXc) then
      ...
      do ii = 1, 3
        call triangleCopySquareMatrix(LrGammaDeriv(:,:,ii))
      end do
...
!$OMP END PARALLEL DO
    ...
    do iL = 1, Lmax
      call triangleCopySquareMatrix(ZmatL(:,:,iL))
    end do
