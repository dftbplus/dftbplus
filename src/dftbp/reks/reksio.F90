...
module dftbp_reks_reksio
  ...
  subroutine printReksSAInfo(env, this, Etotal)
    ...
    case (reksTypes%ssr22)
      call printReksSAInfo22_(env, Etotal, this%enLtot, this%energy, this%FONs, this%Efunction,&
          & this%Plevel)
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  subroutine printReksSAInfo22_(env, Etotal, enLtot, energy, FONs, Efunction, Plevel)
