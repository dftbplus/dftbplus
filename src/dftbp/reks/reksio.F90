...
module dftbp_reks_reksio
  ...
  subroutine printReksSAInfo(this, Etotal, output)
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  subroutine printReksSAInfo22_(Etotal, enLtot, energy, FONs, Efunction, Plevel, output)
    ...
    write(output, "(A)") repeat("-", 50)
    if (Efunction == 1) then
      write(output,'(A25,2x,F15.8)') " Final REKS(2,2) energy:", Etotal
      write(output,*) " "
      ...
      write(output,'(A27,2x,F15.8)') " Final SA-REKS(2,2) energy:", Etotal
      write(output,*) " "
      write(output,'(A46)') " State     Energy      FON(1)    FON(2)   Spin"
      do ist = 1, nstates
        if (ist == 1) then
