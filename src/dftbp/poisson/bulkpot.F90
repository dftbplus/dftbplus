...
module dftbp_poisson_bulkpot
 ...
 use dftbp_poisson_parameters, only : bcPoissonList, contdir, deltaR_max, dmin, iatc, ncont,&
...
contains
 ...
 do m=1,ncont
   ...
   case(1)
     ...
     if(overrBulkBC(3) /= bcPoissonList%Unset) phi_bulk(m)%iparm(2)=overrBulkBC(3)
     if(overrBulkBC(4) /= bcPoissonList%Unset) phi_bulk(m)%iparm(3)=overrBulkBC(4)
     if(overrBulkBC(5) /= bcPoissonList%Unset) phi_bulk(m)%iparm(4)=overrBulkBC(5)
     if(overrBulkBC(6) /= bcPoissonList%Unset) phi_bulk(m)%iparm(5)=overrBulkBC(6)
     !------------------------------------------------------
   ...
   case(2)
     ...
     if(overrBulkBC(5) /= bcPoissonList%Unset) phi_bulk(m)%iparm(2)=overrBulkBC(5)
     if(overrBulkBC(6) /= bcPoissonList%Unset) phi_bulk(m)%iparm(3)=overrBulkBC(6)
     if(overrBulkBC(1) /= bcPoissonList%Unset) phi_bulk(m)%iparm(4)=overrBulkBC(1)
     if(overrBulkBC(2) /= bcPoissonList%Unset) phi_bulk(m)%iparm(5)=overrBulkBC(2)
     !------------------------------------------------------
   ...
   case(3)
     ...
     if(overrBulkBC(1) /= bcPoissonList%Unset) phi_bulk(m)%iparm(2)=overrBulkBC(1)
     if(overrBulkBC(2) /= bcPoissonList%Unset) phi_bulk(m)%iparm(3)=overrBulkBC(2)
     if(overrBulkBC(3) /= bcPoissonList%Unset) phi_bulk(m)%iparm(4)=overrBulkBC(3)
     if(overrBulkBC(4) /= bcPoissonList%Unset) phi_bulk(m)%iparm(5)=overrBulkBC(4)
     !------------------------------------------------------
   ...
   if ( all(phi_bulk(m)%iparm(2:7) == bcPoissonList%periodic) ) then
