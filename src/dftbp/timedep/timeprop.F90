...
!  Integer :: KpointHam = 10
  ...
  type TElecDynamics
    ...
    real(dp), allocatable :: orbCurrents(:,:), atomCurrents(:,:), totalCurrent(:)
...
!        this%tdVecPot(this%currPolDir,:) = -c * this%field
  ...
  subroutine doTdStep(this, boundaryCond, iStep, coord, orb, neighbourList, nNeighbourSK, iSquare,&
    ...
    do iKS = 1, this%parallelKS%nLocalKS
      if (this%tIons .or. (.not. this%tRealHS) .or. this%isRangeSep .or. this%tUseVectorPotential) then
