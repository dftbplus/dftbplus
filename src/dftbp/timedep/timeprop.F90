...
contains
  ...
  subroutine initializeTDVariables(this, env, rho, H1, Ssqr, Sinv, H0, ham0, Dsqr, Qsqr, ints,&
  ...
  subroutine updateH0S(this, boundaryCond, Ssqr, Sinv, coord, orb, neighbourList, nNeighbourSK,&
    ...
    @:PROPAGATE_ERROR(errStatus)
    call getNrOfNeighboursForAll(env%stdOut, nNeighbourSK, neighbourList, this%skCutoff)
  ...
  subroutine initializeDynamics(this, boundaryCond, coord, orb, neighbourList, nNeighbourSK,&
    ...
    call initializeTDVariables(this, env, this%trho, this%H1, this%Ssqr, this%Sinv, H0, this%ham0, &
