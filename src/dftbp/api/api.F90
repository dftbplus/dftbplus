...
module dftbp_api
  ...
  public :: TDftbPlus, getDftbPlusBuild, getDftbPlusApiVersion
...
contains
  ...
  subroutine getDftbPlusApiVersion(major, minor, patch, instanceSafe)
  ...
  end subroutine getDftbPlusApiVersion
