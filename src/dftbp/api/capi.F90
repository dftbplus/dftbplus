...
module dftbp_capi
  ...
  use dftbp_api, only : TDftbPlus, TDftbPlus_destruct, TDftbPlus_init, TDftbPlusAtomList,&
      & TDftbPlusInput
  implicit none
  private
...
contains
  ...
  subroutine c_DftbPlus_api(major, minor, patch) bind(C, name='dftbp_api_version')
