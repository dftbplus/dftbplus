...
#:endif
  ...
  private
  public :: dRhoStaticReal, dRhoFermiChangeStaticReal
  public :: dRhoStaticCmplx, dRhoFermiChangeStaticCmplx
  public :: dRhoStaticPauli, dRhoFermiChangeStaticPauli
  ...
  #:else
    ...
    do iFilled = nEmpty(iS,iK), nFilled(iS,iK)
      workLocal(:, iFilled) = eigVecsCplx(:, iFilled, iKS) * &
          & deltamn(eigvals(iFilled, iK, iS), Ef(iS), tempElec) * dEfdE(iS)
    end do

    workLocal(:, :) = real(3-nSpin,dp) * matmul(workLocal(:, nEmpty(iS,iK):nFilled(iS,iK)),&
