...
contains
  ...
  #:endif
    ...
    ! Duplicate maxScc Iterations as Input to Mixers (required by Broyden)
  ...
  #:endif
    ...
    if (this%tSccCalc .and. .not.this%tRestartNoSC) then
      if (.not. allocated(this%reks)) then
        ...
        write(stdOut, "(A,':',T30,F14.6)") "Mixing parameter", input%ctrl%mixerInp%mixParam
