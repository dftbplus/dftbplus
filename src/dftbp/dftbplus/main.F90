...
contains
  ...
  #:endif
    ...
    if (this%isXlbomd) then
      call getXlbomdCharges(env, this%xlbomdIntegrator, this%qOutRed, this%pChrgMixerReal, this%orb,&
...
#:endif
  ...
  subroutine getXlbomdCharges(env, xlbomdIntegrator, qOutRed, pChrgMixerReal, orb, nIneqOrb,&
