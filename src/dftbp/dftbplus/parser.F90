...
#:endif
  ...
  !> Reads Hamiltonian
#:if WITH_TRANSPORT
  subroutine readHamiltonian(env, node, ctrl, geo, slako, tp, greendens, poisson, errStatus)
#:else
  subroutine readHamiltonian(env, node, ctrl, geo, slako, poisson, errStatus)
#:endif
  ...
  #:endif
    ...
    case ("dftb")
  #:if WITH_TRANSPORT
      call readDFTBHam(env, node, ctrl, geo, slako, tp, greendens, poisson, errStatus)
  #:else
      call readDFTBHam(env, node, ctrl, geo, slako, poisson, errStatus)
  #:endif
      @:PROPAGATE_ERROR(errStatus)
    case ("xtb")
  #:if WITH_TRANSPORT
      call readXTBHam(env, node, ctrl, geo, tp, greendens, poisson, errStatus)
  #:else
      call readXTBHam(env, node, ctrl, geo, poisson, errStatus)
  #:endif
      @:PROPAGATE_ERROR(errStatus)
    case default
...
#:if WITH_TRANSPORT
  subroutine readDFTBHam(env, node, ctrl, geo, slako, tp, greendens, poisson, errStatus)
#:else
  subroutine readDFTBHam(env, node, ctrl, geo, slako, poisson, errStatus)
#:endif
  ...
  #:endif
    ...
    ! K-Points
    call readKPoints(env, node, ctrl, geo, errStatus)
    @:PROPAGATE_ERROR(errStatus)
...
#:if WITH_TRANSPORT
  subroutine readXTBHam(env, node, ctrl, geo, tp, greendens, poisson, errStatus)
#:else
  subroutine readXTBHam(env, node, ctrl, geo, poisson, errStatus)
#:endif
...
#:endif
  ...
  !> K-Points
  subroutine readKPoints(env, node, ctrl, geo, errStatus)
