...
contains
  ...
  #:else
    ...
    ! electronic Hamiltonian and energy model
    call getChildValue(root, "Model", hamNode)
    call readModelChoice(hamNode, input%ctrl, input%geom, input%slako, input%poisson, errStatus)
...
#:endif
  ...
  !> Reads Hamiltonian
#:if WITH_TRANSPORT
  subroutine readModelChoice(node, ctrl, geo, slako, tp, greendens, poisson, errStatus)
#:else
  subroutine readModelChoice(node, ctrl, geo, slako, poisson, errStatus)
#:endif
  ...
  #:endif
    ...
    case ("dftb")
  #:if WITH_TRANSPORT
      call readDFTBModel(node, ctrl, geo, slako, tp, greendens, poisson, errStatus)
  #:else
      call readDFTBModel(node, ctrl, geo, slako, poisson, errStatus)
  #:endif
      @:PROPAGATE_ERROR(errStatus)
    case ("xtb")
  #:if WITH_TRANSPORT
      call readXTBModel(node, ctrl, geo, tp, greendens, poisson, errStatus)
  #:else
      call readXTBModel(node, ctrl, geo, poisson, errStatus)
  #:endif
    case ("external")
  #:if WITH_TRANSPORT
      call readExternalHam(node, ctrl, geo, tp, greendens, poisson, errStatus)
  #:else
      call readExternalHam(node, ctrl, geo, poisson, errStatus)
  #:endif
      @:PROPAGATE_ERROR(errStatus)
    case default
...
#:if WITH_TRANSPORT
  subroutine readDFTBModel(node, ctrl, geo, slako, tp, greendens, poisson, errStatus)
#:else
  subroutine readDFTBModel(node, ctrl, geo, slako, poisson, errStatus)
#:endif
...
#:if WITH_TRANSPORT
  subroutine readXTBModel(node, ctrl, geo, tp, greendens, poisson, errStatus)
#:else
  subroutine readXTBModel(node, ctrl, geo, poisson, errStatus)
#:endif
