...
#:if WITH_CHIMES
  ...
  interface TChimesRep
    module procedure TChimesRep_construct
  end interface
...
#:if WITH_CHIMES
  ...
  !> Constructs ChIMES repulsive.
  function TChimesRep_construct(input, speciesNames, species0) result(this)
