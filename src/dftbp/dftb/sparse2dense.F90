...
!               & img2CentCell, rhoPrimSize, over, tiTraCharges, tiTransDipoleMoment, q0, coord, iAtInCentralRegion, &
...
!    real(dp), intent(inout) :: tiTransDipoleMoment(:)
!
...
!    do ii = 1, size(iAtInCentralRegion)
!      iAtom = iAtInCentralRegion(ii)
!      tiTransDipoleMoment(:) = tiTransDipoleMoment(:)&
