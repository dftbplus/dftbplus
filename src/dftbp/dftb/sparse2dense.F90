...
#:endif
  ...
  private
  public :: unpackHS, packHS, iPackHS, packErho, unpackDQ, unpackHSdk, unpackHSd2k
...
#:endif
  ...
  subroutine getSparseDescriptor(iNeighbour, nNeighbourSK, img2CentCell, orb, iSparseStart, sparseSize)
