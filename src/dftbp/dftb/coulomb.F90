...
module dftbp_dftb_coulomb
  ...
  use dftbp_dftb_boundarycond, only : boundaryConditionList
...
contains
  ...
  #:endif
    ...
    if (this%boundaryCond_ == boundaryConditionList%pbc3d) then
...
99020 format ('Failure in getMaxREwald.', ' Error nr: ',I3)
  ...
  subroutine getPotential(this, env, coords, chargeCoords, charges, potential, blurWidths,&
    ...
    if (this%boundaryCond_ == boundaryConditionList%cluster) then
