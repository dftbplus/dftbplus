...
#:endif
  ...
  type TSccInput
    ...
    integer :: boundaryCond = boundaryConditionList%unknown
  ...
  integer, parameter :: implementedBoundaryConds_(*) =&
      & [boundaryConditionList%cluster, boundaryConditionList%pbc3d]
...
contains
  ...
  subroutine TScc_init(this, input, env, orb)
    ...
    this%tPeriodic = (input%boundaryCond == boundaryConditionList%pbc3d)
