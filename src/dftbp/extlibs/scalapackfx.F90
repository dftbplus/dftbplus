...
#:if WITH_SCALAPACK
  use libscalapackfx_module, only : blacsfx_gemr2d, blacsfx_gsum, blacsgrid, blocklist, CSRC_,&
      & DLEN_, linecomm, M_, MB_, N_, NB_, pblasfx_pgemm, pblasfx_phemm, pblasfx_pherk,&
      & pblasfx_psymm, pblasfx_psymv, pblasfx_psyrk, pblasfx_ptran, pblasfx_ptranc,&
      & pblasfx_ptranu, RSRC_, scalafx_addg2l, scalafx_addl2g,&
