...
#:if WITH_ELSI
  use elsi, only : elsi_dm_complex, elsi_dm_complex_sparse, elsi_dm_real, elsi_dm_real_sparse,&
      ...
      & elsi_set_elpa_gpu, elsi_set_elpa_solver, elsi_set_elpa_n_single, elsi_set_kpoint,&
...
#:endif
  ...
  public :: elsi_set_elpa_solver, elsi_set_elpa_autotune, elsi_set_elpa_gpu, elsi_set_elpa_n_single
...
#:if not WITH_ELSI
  ...
  subroutine elsi_set_elpa_n_single(eh, n)
    type(elsi_handle), intent(inout) :: eh
