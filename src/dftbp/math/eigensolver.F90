...
#:for TYPE, KIND, SUFFIX, MAGMA_ROUTINE in &
    & [("real", "rsp", "real", "magma_f_ssyevd_m"),&
    &  ("real", "rdp", "dreal", "magma_f_dsyevd_m"),&
    &  ("complex", "rsp", "complex", "magma_f_cheevd_m"),&
    &  ("complex", "rdp", "dcomplex", "magma_f_zheevd_m")]
...
#:for TYPE, KIND, SUFFIX, MAGMA_ROUTINE in &
    & [("real", "rsp", "real", "magma_f_ssygvd_m"),&
    &  ("real", "rdp", "dreal", "magma_f_dsygvd_m"),&
    &  ("complex", "rsp", "complex", "magma_f_chegvd_m"),&
    &  ("complex", "rdp", "dcomplex", "magma_f_zhegvd_m")]
