...
contains
  ...
  subroutine getLatticePoints(latPoint, latVec, recVec2p, dist, posExtension, &
    ...
    ! In order to make sure that (0,0,0) is the first point, points are generated by the iterator
    ! will not contain origin, which is inserted as first element later
