...
contains
  ...
  subroutine add2centShift(potential, qBlock, q, q0, orb, ons_en, species, nNeighbor, iNeighbor,&
      & over, iPair, hubbU, W)
    real(dp), intent(inout)        :: potential(:,:,:,:)
    real(dp), intent(in)           :: qBlock(:,:,:,:)
  ...
  subroutine addonsForce(deriv, DM, species, iNeighbor, nNeighbor, coords, iPair, img2CentCell,&
      & qblock, q, q0, orb, ons_en, skOverCont, skHamCont, derivator)
