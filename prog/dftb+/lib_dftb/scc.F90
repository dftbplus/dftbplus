...
module dftbp_scc
  ...
  use dftbp_constants
  use dftbp_coulomb, only : TCoulombCont, TCoulombInput, init, sumInvR, invRPrime
...
contains
  ...
  subroutine updateCharges(this, env, qOrbital, orb, species, q0)
    ...
    call getSummedCharges(species, orb, qOrbital, q0, this%iHubbU, this%deltaQ, this%deltaQAtom,&
        & this%deltaQPerLShell, this%deltaQUniqU)
  ...
  subroutine getEnergyPerAtomXlbomd(this, species, orb, qOut, q0, eScc)
    ...
    call getSummedCharges(species, orb, qOut, q0, this%iHubbU, dQOut, dQOutAtom, dQOutShell)
  ...
  subroutine addForceDcXlbomd(this, env, species, orb, iNeighbour, img2CentCell, qOrbitalOut,&
    ...
    call getSummedCharges(species, orb, qOrbitalOut, q0,  this%iHubbU, dQOut, dQOutAtom,&
