...
contains
  ...
  !> Real case of orthogonalising against degenerate perturbation operation cases
  ...
  subroutine realUnitary(U, matrixToProcess, ei, tol)
    ...
    do iGrp = 1, nGrp
      ...
      call heev(subBlock(:iRange, :iRange), eigenvals, 'L', 'V')
