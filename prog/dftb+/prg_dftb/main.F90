      ...
      lpSCC: do iSccIter = 1, maxSccIter
        ...
        if (tSccCalc) then
          ...
          if (tWriteSccRestart) then
            call writeCharges(fCharges, fdCharges, tWriteChrgBinary, orb, qInput, qBlockIn,&
                & qiBlockIn)
          end if
        end if
...
#:endif
        ...
        if (tWriteCharges) then
          call writeCharges(fCharges, fdCharges, tWriteChrgBinary, orb, qInput, qBlockIn, qiBlockIn)
        end if
