...
program test_qdepextpot
  ...
  real(dp), parameter :: coords(3, 3) = reshape([&
  ...
  real(dp), parameter :: extChargeCoords(3, 2) = reshape([&
  ...
  real(dp), parameter :: extCharges(2) = [2.5_dp, -1.9_dp]
  ...
  call TExtChargePotGen_init(extChargePotGen, coords, extChargeCoords, extCharges)
