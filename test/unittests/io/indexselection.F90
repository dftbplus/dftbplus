...
#:contains
  ...
  #:contains
    ...
    #:block TEST("explicit")
      call getIndexSelection("1 2 4", fullRange, selected, status, speciesNames=speciesNames,&
          & species=species)
      @:ASSERT(status%isOk())
    ...
    #:block TEST("allAsRange")
      call getIndexSelection("1:-1", fullRange, selected, status, speciesNames=speciesNames,&
          & species=species)
      @:ASSERT(status%isOk())
      @:ASSERT(all(selected))
    #:endblock
    ...
    #:block TEST("range")
      call getIndexSelection("2:6", fullRange, selected, status, speciesNames=speciesNames,&
          & species=species)
      @:ASSERT(status%isOk())
    ...
    #:block TEST("negativeSubrange")
      call getIndexSelection("-6:-2", fullRange, selected, status, speciesNames=speciesNames,&
          & species=species)
      @:ASSERT(status%isOk())
    ...
    #:block TEST("speciesName")
      call getIndexSelection("Si", fullRange, selected, status, speciesNames=speciesNames,&
          & species=species)
      @:ASSERT(status%isOk())
    ...
    #:block TEST("excludeIndices")
      call getIndexSelection("!4:14", fullRange, selected, status, speciesNames=speciesNames,&
          & species=species)
      @:ASSERT(status%isOk())
    ...
    #:block TEST("excludeSpecies")
      call getIndexSelection("!C", fullRange, selected, status, speciesNames=speciesNames,&
          & species=species)
      @:ASSERT(status%isOk())
      @:ASSERT(checkSelection(selected, fullRange, [1, 3, 5, 7, 9, 11, 13, 15]))
    #:endblock
    ...
    #:block TEST("zeroIndexingPositive")
      call getIndexSelection("0 2 3", [0, nAtom - 1], selected, status,&
          speciesNames=speciesNames, species=species)
      @:ASSERT(status%isOk())
    ...
    #:block TEST("zeroIndexingNegative")
      call getIndexSelection("-16:-14", [0, nAtom - 1], selected, status,&
          speciesNames=speciesNames, species=species)
      @:ASSERT(status%isOk())
    ...
    #:block TEST("subrange")
      call getIndexSelection("11:13", [9, 16], selected(9:16), status, speciesNames=speciesNames,&
          & species=species(9:16), indexRange=fullRange)
      @:ASSERT(status%isOk())
    ...
    #:block TEST("selectWrongSpeciesName")
      call getIndexSelection("Mg", fullRange, selected, status, speciesNames=speciesNames,&
          & species=species)
  ...
  #:contains
     ...
     #:block TEST("explicit")
       call getIndexSelection("5 6 7", fullRange, selected, status)
       @:ASSERT(status%isOk())
       @:ASSERT(checkSelection(selected, fullRange, [5, 6, 7]))
      #:endblock

      #:block TEST("range")
        call getIndexSelection("-4:-2", fullRange, selected, status)
        @:ASSERT(status%isOk())
  ...
  #:contains
     ...
     #:block TEST("explicit")
       call getIndexSelection("-1 0 1", fullRange, selected, status)
       @:ASSERT(status%isOk())
       @:ASSERT(checkSelection(selected, fullRange, [-1, 0, 1]))
      #:endblock

      #:block TEST("range")
        call getIndexSelection("-1:1", fullRange, selected, status)
        @:ASSERT(status%isOk())
        @:ASSERT(checkSelection(selected, fullRange, [-1, 0, 1]))
       #:endblock
