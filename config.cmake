...
option(WITH_MAGMA "Whether DFTB+ should be built with the MAGMA library" "${WITH_GPU} AND NOT ${WITH_MPI}")
# This must be turned on for serial (non-MPI) builds, if the GPU-support was enabled. For MPI
# parallel builds the MAGMA library support must be disabled.

option(WITH_ELSI "Whether DFTB+ with MPI-parallelism should use the ELSI libraries" FALSE)
# Works only with MPI-parallel build. If WITH_GPU was selected above, the ELSI library must have
# been built with GPU support enabled.
