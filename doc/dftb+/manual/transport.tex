...
\item[\iscb{BuettikerProbes}] \label{Buttiker} Block used to specify dephasing model based on 
	B\:uttiker probes. 
...
More precisely, if both \is{AtomBlock=No} and \is{SemiLocal=No}, then the self-energies are 
