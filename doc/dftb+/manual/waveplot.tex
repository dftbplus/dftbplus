...
\item[\is{SpGridPoints}] Same functionality as "TotGridPoints". Specifies the
  ...
  tabulated before they get mapped onto the total grid.
...
calculation of the radial wavefunctions can be used if "RadialWFTabulation"
...
be provided, if one of the interpolation types is specified for "RadialWFTabulation".
The Basis definition is similar to the previous case, but the radial wavefunction is
tabulated instead of the coefficients and exponents. As an example, the "Basis"
