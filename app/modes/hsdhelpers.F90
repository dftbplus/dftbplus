...
module modes_hsdhelpers
  ...
  use modes_parser, only : TParserFlags, rootTag, readHsdFile, parseHsdTree
  implicit none
  ...
  !> Name of the MODES input file
  character(*), parameter :: hsdFileName = "modes_in.hsd"

  !> Name of the MODES processed input file
  character(*), parameter :: hsdProcFileName = "modes_pin.hsd"
