...
contains
  ...
  subroutine writePropertyToCube(plotType, data, wp, levelIndex, ioStat)
    ...
    !> 3D buffer to write to cube file
    real(dp), intent(in) :: data(:,:,:)
    
    !> Program variables, for geometry etc.
    type(TProgramVariables), intent(in) :: wp
    ...
    case ("charge")
      fileSuffix = "-abs2.cube"
      commentSuffix = ", abs2"
    case ("chargediff")
      fileSuffix = "-abs2diff.cube"
      commentSuffix = ", abs2diff"
    case ("real")
      fileSuffix = "-real.cube"
      commentSuffix = ", real"
    case ("imag")
      fileSuffix = "-imag.cube"
      commentSuffix = ", imag"
    case ("atomdens")
      fileSuffix = "wp-atomdens.cube"
      commentSuffix = ", atomdens"
    case ("total_charge")
      fileSuffix = "wp-abs2.cube"
      commentSuffix = ", abs2"
    case ("total_chargediff")
      fileSuffix = "wp-abs2diff.cube"
      commentSuffix = ", abs2diff"
    case ("spinpol")
      fileSuffix = "wp-spinpol.cube"
      commentSuffix = ", spinpol"
    case default
