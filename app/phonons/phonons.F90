...
contains
  ...
  subroutine printHeader(output)
    ...
    write (output, "(A)") "A tool to compute phonon transmission in nanostructures based on Hessians"
    ...
    write (output, "(A)") "nanomaterials: combining atomistic with non-equilibrium Green's functions"
