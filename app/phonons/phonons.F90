...
contains
  ...
  subroutine printHeader(env)
    ...
    write (env%stdOut, "(A)") "A tool to compute phonon transmission in nanostructures based on Hessians"
    ...
    write (env%stdOut, "(A)") "nanomaterials: combining atomistic with non-equilibrium Green's functions"
