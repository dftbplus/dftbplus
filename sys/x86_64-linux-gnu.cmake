...
set(CMAKE_Fortran_FLAGS "" CACHE LIST "General Fortran flags")

set(CMAKE_Fortran_FLAGS_RELEASE "-O2 -mavx -funroll-all-loops" CACHE LIST
...
set(CMAKE_C_FLAGS_RELEASE "-O2 -funroll-all-loops" CACHE LIST "Specific C flags for Release mode")
...
# Debug settings
#
set(CMAKE_Fortran_FLAGS_DEBUG "-g -Wall -std=f2008 -pedantic -fbounds-check" CACHE LIST
