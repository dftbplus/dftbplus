...
set(CMAKE_Fortran_FLAGS "-ieee=full -mismatch" CACHE LIST "General Fortran flags")
...
set(CMAKE_C_FLAGS_RELEASE "-O2 -funroll-all-loops -fall-intrinsics" CACHE LIST
...
if(WITH_MPI)
  ...
  set(SCALAPACK_LIBRARY_PATHS "" CACHE STRING
  ...
  set(LAPACK_LIBRARY_PATHS "" CACHE
...
# Debug settings
#
set(CMAKE_Fortran_FLAGS_DEBUG "-f2008 -g -gline -C=all -nan -mtrace=all" CACHE LIST
  "Specific Fortran flags for Debug mode")

set(CMAKE_C_FLAGS_DEBUG "-g -Wall -pedantic -fall-intrinsics -fbounds-check" CACHE LIST
